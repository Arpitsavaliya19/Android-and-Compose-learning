...
// TODO: Screen enum
enum class LaunchTrayScreen(@StringRes val Screenname: Int) {
    StartOrder(Screenname = R.string.app_name),
    EntreeMenu(Screenname = R.string.choose_entree),
    SideDishMenu(Screenname = R.string.choose_side_dish),
    AccompanimentMenu(Screenname = R.string.choose_accompaniment),
...
fun LunchTrayApp() {
    ...
    val currentScreen = LaunchTrayScreen.valueOf(
        backStackEntry?.destination?.route?: LaunchTrayScreen.StartOrder.name
    )

    Scaffold(
        topBar = {
            // TODO: AppBar
            LaunchTrayScreenAppBar(
        ...
        NavHost(
            ...
            startDestination = LaunchTrayScreen.StartOrder.name,
            modifier = Modifier.padding(innerPadding)
        ) {
            composable(route = LaunchTrayScreen.StartOrder.name) {
                StartOrderScreen(
                ...
                EntreeMenuScreen(
                    ...
                    onCancelButtonClicked = {
                        ...
                        navController.popBackStack(
                            LaunchTrayScreen.StartOrder.name,
                            inclusive = false
                        )
                    },
                    onNextButtonClicked = {
